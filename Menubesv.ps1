...
do {
    Show-BESVHeader 'BESV PowerShell automation - AP University College SNB'
    ...
    Write-Host '  3  Base configuration Windows Client: set computer name' -ForegroundColor Green
    Write-Host '  4  Base configuration Windows Client: set network' -ForegroundColor Green
    ...
    Write-Host '  8  Create domain users' -ForegroundColor Green
    Write-Host '  9  Add domain users to security groups' -ForegroundColor Green
    Write-Host ' 10  Create folders and shares' -ForegroundColor Green
    ...
    switch ($choice.ToUpper()) {
        ...
        '8'  { Invoke-BESVAction 'Create domain users' { New-BESVDomainUsers } }
        '9'  { Invoke-BESVAction 'Add users to groups' { Add-BESVUsersToGroups } }
        '10' { Invoke-BESVAction 'Create folders and shares' { New-BESVFolders; New-BESVShares } }
