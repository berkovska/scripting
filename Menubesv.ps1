...
#>
    do {
        ...
        Write-Host "   PowerShell Installatietool"  -ForegroundColor Cyan
        Write-Host "===============================" -ForegroundColor Cyan
        Write-Host ""
        ...
        switch ($keuze.ToUpper()) {
            ...
            default { Write-Host "Ongeldige keuze, probeer opnieuw." -ForegroundColor Red ; Start-Sleep 1 }
        }
    } while ($true)
}
...
#>
    do {
        ...
        switch ($keuze.ToUpper()) {
            ...
            "Q" { return }
            default { Write-Host "Ongeldige keuze." -ForegroundColor Red ; Start-Sleep 1 }
        }
    } while ($true)
}
...
#>
    do {
        Clear-Host
        Write-Host "===============================" -ForegroundColor Cyan
        Write-Host "   Domein configuratie"          -ForegroundColor Cyan
        Write-Host "===============================" -ForegroundColor Cyan
        Write-Host ""
